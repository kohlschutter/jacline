...
public class Visitor_InstanceOfExpression {
  ...
  public static Expression visit(Processor processor, InstanceOfExpression instanceOfExpression) {
  ...
  static void visitMembers(Processor processor, InstanceOfExpression instanceOfExpression) {
    ...
    Visitor_Expression.visitMembers(processorImpl, instanceOfExpression);
      instanceOfExpression.leftOperand = (Expression) Preconditions.checkNotNull(
      instanceOfExpression.leftOperand.acceptInternal(processorImpl),
          "Field \"leftOperand\" in class \"InstanceOfExpression\" cannot be null");
      instanceOfExpression.rightOperand = (TypeReference) Preconditions.checkNotNull(
      instanceOfExpression.rightOperand.acceptInternal(processorImpl),
          "Field \"rightOperand\" in class \"InstanceOfExpression\" cannot be null");
  }
}
