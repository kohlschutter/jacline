...
public static native <S extends @Nullable Object> Uint8ClampedArray from(Uint8ClampedArray.FromSourceUnionType source,Uint8ClampedArray.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S extends @Nullable Object> Uint8ClampedArray from(JsArrayLike<Double> source,Uint8ClampedArray.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S extends @Nullable Object> Uint8ClampedArray from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Uint8ClampedArray.FromMapFn mapFn,S thisArg){
return from(Js.<Uint8ClampedArray.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
public static final Uint8ClampedArray from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Uint8ClampedArray.FromMapFn mapFn){
return from(Js.<Uint8ClampedArray.FromSourceUnionType>uncheckedCast(source),mapFn);
}
@JsOverlay
public static final Uint8ClampedArray from(JsIterable<Double, @Nullable Object, @Nullable Object> source){
return from(Js.<Uint8ClampedArray.FromSourceUnionType>uncheckedCast(source));
}
@JsOverlay
public static final <S extends @Nullable Object> Uint8ClampedArray from(String source,Uint8ClampedArray.FromMapFn mapFn,S thisArg){
return from(Js.<Uint8ClampedArray.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
@JsOverlay
public static final <S extends @Nullable Object> Uint8ClampedArray from(double[] source,Uint8ClampedArray.FromMapFn mapFn,S thisArg){
...
public Uint8ClampedArray(Uint8ClampedArray.@Nullable ConstructorLengthUnionType length,int byteOffset,int length0){}
public Uint8ClampedArray(Uint8ClampedArray.@Nullable ConstructorLengthUnionType length,int byteOffset){}
