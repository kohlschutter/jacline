...
@JsOverlay
public static final int BYTES_PER_ELEMENT=Uint32Array__Constants.BYTES_PER_ELEMENT;
public static native <S extends @Nullable Object> Uint32Array from(Uint32Array.FromSourceUnionType source,Uint32Array.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S extends @Nullable Object> Uint32Array from(JsArrayLike<Double> source,Uint32Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S extends @Nullable Object> Uint32Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Uint32Array.FromMapFn mapFn,S thisArg){
return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
public static final Uint32Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Uint32Array.FromMapFn mapFn){
return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source),mapFn);
}
@JsOverlay
public static final Uint32Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source){
return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source));
}
@JsOverlay
public static final <S extends @Nullable Object> Uint32Array from(String source,Uint32Array.FromMapFn mapFn,S thisArg){
return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
@JsOverlay
public static final <S extends @Nullable Object> Uint32Array from(double[] source,Uint32Array.FromMapFn mapFn,S thisArg){
...
public Uint32Array(Uint32Array.@Nullable ConstructorLengthUnionType length,int byteOffset,int length0){}
