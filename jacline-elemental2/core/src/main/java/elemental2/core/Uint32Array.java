...
public static native <S>Uint32Array from(Uint32Array.FromSourceUnionType source,Uint32Array.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S>Uint32Array from(JsArrayLike<Double> source,Uint32Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S>Uint32Array from(JsIterable<Double> source,Uint32Array.FromMapFn mapFn,S thisArg){
return from(Js.<Uint32Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
@JsOverlay
public static final <S>Uint32Array from(double[] source,Uint32Array.FromMapFn mapFn,S thisArg){
