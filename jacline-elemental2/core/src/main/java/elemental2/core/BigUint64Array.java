...
public static native <S>BigUint64Array from(BigUint64Array.FromSourceUnionType source,BigUint64Array.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S>BigUint64Array from(JsArrayLike<JsBigint> source,BigUint64Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S>BigUint64Array from(JsBigint[] source,BigUint64Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S>BigUint64Array from(JsIterable<JsBigint> source,BigUint64Array.FromMapFn mapFn,S thisArg){
return from(Js.<BigUint64Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
public static final BigUint64Array from(JsIterable<JsBigint> source,BigUint64Array.FromMapFn mapFn){
return from(Js.<BigUint64Array.FromSourceUnionType>uncheckedCast(source),mapFn);
}
@JsOverlay
...
@JsOverlay
public static final <S>BigUint64Array from(String source,BigUint64Array.FromMapFn mapFn,S thisArg){
return from(Js.<BigUint64Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
public BigUint64Array(BigUint64Array.ConstructorLengthOrArrayOrBufferUnionType lengthOrArrayOrBuffer,double byteOffset,double bufferLength){}
public BigUint64Array(BigUint64Array.ConstructorLengthOrArrayOrBufferUnionType lengthOrArrayOrBuffer,double byteOffset){}
public BigUint64Array(BigUint64Array.ConstructorLengthOrArrayOrBufferUnionType lengthOrArrayOrBuffer){}
