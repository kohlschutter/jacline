...
public static native <T, S, R>JsArray<R> from(JsArray.FromArrayLikeUnionType<T> arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn,S this_);
public static native <T, R>JsArray<R> from(JsArray.FromArrayLikeUnionType<T> arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn);
public static native <T, R>JsArray<R> from(JsArray.FromArrayLikeUnionType<T> arrayLike);
@JsOverlay
public static final <T, S, R>JsArray<R> from(JsArrayLike<T> arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn,S this_){
return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike),mapFn,this_);
}
@JsOverlay
public static final <T, R>JsArray<R> from(JsArrayLike<T> arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn){
...
@JsOverlay
public static final <T, S, R>JsArray<R> from(JsIterable<T> arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn,S this_){
return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike),mapFn,this_);
}
@JsOverlay
public static final <T, R>JsArray<R> from(JsIterable<T> arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn){
return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike),mapFn);
}
@JsOverlay
...
@JsOverlay
public static final <T, S, R>JsArray<R> from(String arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn,S this_){
return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike),mapFn,this_);
}
@JsOverlay
public static final <T, R>JsArray<R> from(String arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn){
return from(Js.<JsArray.FromArrayLikeUnionType<T>>uncheckedCast(arrayLike),mapFn);
}
@JsOverlay
...
@JsOverlay
public static final <T, S, R>JsArray<R> from(T[] arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn,S this_){
return from(Js.<JsArrayLike<T>>uncheckedCast(arrayLike),mapFn,this_);
}
@JsOverlay
public static final <T, R>JsArray<R> from(T[] arrayLike,JsArray.FromMapFn<? super T, ? extends R> mapFn){
...
public native <S>JsArray<T> filter(ReadonlyArray.FilterCallbackFn<? super T> callback,S thisobj);
...
public native <S>T findLast(ReadonlyArray.FindLastPredicateFn<T> predicateFn,S this_);
public native T findLast(ReadonlyArray.FindLastPredicateFn<T> predicateFn);
public native <S>int findLastIndex(ReadonlyArray.FindLastIndexPredicateFn<T> predicateFn,S this_);
...
public native <THIS, S>JsArray<S> flatMap(ReadonlyArray.FlatMapCallbackFn<S, T> callback,THIS thisArg);
...
public native <S, R>JsArray<R> map(ReadonlyArray.MapCallbackFn<? extends R, ? super T> callback,S thisobj);
public native <R>JsArray<R> map(ReadonlyArray.MapCallbackFn<? extends R, ? super T> callback);
public native T pop();
public native int push(T... var_args);
public native <R>R reduce(ReadonlyArray.ReduceCallbackFn<? extends R, ? super T> callback,Object initialValue);
public native <R>R reduce(ReadonlyArray.ReduceCallbackFn<? extends R, ? super T> callback);
public native <R>R reduceRight(ReadonlyArray.ReduceRightCallbackFn<? extends R, ? super T> callback,Object initialValue);
public native <R>R reduceRight(ReadonlyArray.ReduceRightCallbackFn<? extends R, ? super T> callback);
