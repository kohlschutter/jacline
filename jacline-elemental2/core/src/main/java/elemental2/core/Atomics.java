...
public static native double add(Atomics.AddTypedArrayUnionType typedArray,int index,double value);
@JsOverlay
...
public static native double and(Atomics.AndTypedArrayUnionType typedArray,int index,double value);
@JsOverlay
...
@JsOverlay
public static final double compareExchange(BigInt64Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double compareExchange(BigUint64Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
public static native double compareExchange(Atomics.CompareExchangeTypedArrayUnionType typedArray,int index,double expectedValue,double replacementValue);
@JsOverlay
public static final double compareExchange(Int16Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double compareExchange(Int32Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double compareExchange(Int8Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double compareExchange(Uint16Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double compareExchange(Uint32Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double compareExchange(Uint8Array typedArray,int index,double expectedValue,double replacementValue){
return compareExchange(Js.<Atomics.CompareExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,expectedValue,replacementValue);
}
@JsOverlay
public static final double exchange(BigInt64Array typedArray,int index,double value){
return exchange(Js.<Atomics.ExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,value);
}
@JsOverlay
public static final double exchange(BigUint64Array typedArray,int index,double value){
return exchange(Js.<Atomics.ExchangeTypedArrayUnionType>uncheckedCast(typedArray),index,value);
}
public static native double exchange(Atomics.ExchangeTypedArrayUnionType typedArray,int index,double value);
@JsOverlay
...
public static native double notify(Atomics.NotifyTypedArrayUnionType typedArray,int index,double count);
...
public static native double store(Atomics.StoreTypedArrayUnionType typedArray,int index,double value);
@JsOverlay
...
public static native double sub(Atomics.SubTypedArrayUnionType typedArray,int index,double value);
@JsOverlay
...
@JsOverlay
public static final String wait(BigInt64Array typedArray,int index,double value,double timeout){
return wait(Js.<Atomics.WaitTypedArrayUnionType>uncheckedCast(typedArray),index,value,timeout);
}
@JsOverlay
...
public static native String wait(Atomics.WaitTypedArrayUnionType typedArray,int index,double value,double timeout);
public static native String wait(Atomics.WaitTypedArrayUnionType typedArray,int index,double value);
...
public static native double xor(Atomics.XorTypedArrayUnionType typedArray,int index,double value);
}
