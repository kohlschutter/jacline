...
public static native <S extends @Nullable Object> Uint8Array from(Uint8Array.FromSourceUnionType source,Uint8Array.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S extends @Nullable Object> Uint8Array from(JsArrayLike<Double> source,Uint8Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S extends @Nullable Object> Uint8Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Uint8Array.FromMapFn mapFn,S thisArg){
return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
public static final Uint8Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Uint8Array.FromMapFn mapFn){
return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source),mapFn);
}
@JsOverlay
public static final Uint8Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source){
return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source));
}
@JsOverlay
public static final <S extends @Nullable Object> Uint8Array from(String source,Uint8Array.FromMapFn mapFn,S thisArg){
return from(Js.<Uint8Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
@JsOverlay
public static final <S extends @Nullable Object> Uint8Array from(double[] source,Uint8Array.FromMapFn mapFn,S thisArg){
...
public Uint8Array(Uint8Array.@Nullable ConstructorLengthUnionType length,int byteOffset,int length0){}
