...
public static native <S extends @Nullable Object> Float32Array from(Float32Array.FromSourceUnionType source,Float32Array.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S extends @Nullable Object> Float32Array from(JsArrayLike<Double> source,Float32Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S extends @Nullable Object> Float32Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Float32Array.FromMapFn mapFn,S thisArg){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
public static final Float32Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Float32Array.FromMapFn mapFn){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source),mapFn);
}
@JsOverlay
public static final Float32Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source));
}
@JsOverlay
public static final <S extends @Nullable Object> Float32Array from(String source,Float32Array.FromMapFn mapFn,S thisArg){
return from(Js.<Float32Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
@JsOverlay
public static final <S extends @Nullable Object> Float32Array from(double[] source,Float32Array.FromMapFn mapFn,S thisArg){
...
public Float32Array(Float32Array.@Nullable ConstructorLengthUnionType length,int byteOffset,int length0){}
