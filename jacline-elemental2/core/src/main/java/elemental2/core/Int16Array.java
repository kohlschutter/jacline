...
public static native <S extends @Nullable Object> Int16Array from(Int16Array.FromSourceUnionType source,Int16Array.FromMapFn mapFn,S thisArg);
...
@JsOverlay
public static final <S extends @Nullable Object> Int16Array from(JsArrayLike<Double> source,Int16Array.FromMapFn mapFn,S thisArg){
...
@JsOverlay
public static final <S extends @Nullable Object> Int16Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Int16Array.FromMapFn mapFn,S thisArg){
return from(Js.<Int16Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
public static final Int16Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source,Int16Array.FromMapFn mapFn){
return from(Js.<Int16Array.FromSourceUnionType>uncheckedCast(source),mapFn);
}
@JsOverlay
public static final Int16Array from(JsIterable<Double, @Nullable Object, @Nullable Object> source){
return from(Js.<Int16Array.FromSourceUnionType>uncheckedCast(source));
}
@JsOverlay
public static final <S extends @Nullable Object> Int16Array from(String source,Int16Array.FromMapFn mapFn,S thisArg){
return from(Js.<Int16Array.FromSourceUnionType>uncheckedCast(source),mapFn,thisArg);
}
@JsOverlay
...
@JsOverlay
public static final <S extends @Nullable Object> Int16Array from(double[] source,Int16Array.FromMapFn mapFn,S thisArg){
...
public Int16Array(Int16Array.@Nullable ConstructorLengthUnionType length,int byteOffset,int length0){}
