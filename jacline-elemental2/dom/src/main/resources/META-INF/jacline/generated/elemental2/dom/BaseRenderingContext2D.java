...
import elemental2.dom.CanvasDrawingStyles;
import elemental2.dom.TextMetrics;
import elemental2.dom.CanvasRenderingContext2DSettings;
...
@Deprecated
public native void setFillColor(BaseRenderingContext2D.SetFillColorAUnionType a,double b,double c,double d,double e);
@Deprecated
public native void setFillColor(BaseRenderingContext2D.SetFillColorAUnionType a,double b,double c,double d);
@Deprecated
public native void setFillColor(BaseRenderingContext2D.SetFillColorAUnionType a,double b,double c);
@Deprecated
...
@Deprecated
public native void setStrokeColor(BaseRenderingContext2D.SetStrokeColorAUnionType a,double b,double c,double d,double e);
@Deprecated
public native void setStrokeColor(BaseRenderingContext2D.SetStrokeColorAUnionType a,double b,double c,double d);
@Deprecated
public native void setStrokeColor(BaseRenderingContext2D.SetStrokeColorAUnionType a,double b,double c);
@Deprecated
...
setStrokeColor(Js.<BaseRenderingContext2D.SetStrokeColorAUnionType>uncheckedCast(a),b,c,d,e);
}
@JsOverlay
@Deprecated
