...
@JsOverlay
static JavaScriptAudioNode.@Nullable OnaudioprocessUnionType of(@Nullable Object o){
return Js.cast(o);
}
@JsOverlay
...
@JsOverlay
default JavaScriptAudioNode.@Nullable OnaudioprocessFn asOnaudioprocessFn(){
return Js.cast(this);
}
@JsOverlay
...
@Deprecated
public JavaScriptAudioNode.@Nullable OnaudioprocessUnionType onaudioprocess;
}
